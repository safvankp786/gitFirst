						...
						<?php if ( $main_fields_active ) : ?>
							<?php foreach ( $attributes['main_fields'] as $field ) :
								...
								if ( $field_config && ! empty( $field_config['search_support'] ) ) :
									...
									if ( $content ) :
										$placeholder = es_get_search_placeholder( $field, $field_config ); ?>
                                        <li class="js-es-search-nav__single-item js-es-search-nav__item" data-placeholder="<?php echo $placeholder; ?>"
