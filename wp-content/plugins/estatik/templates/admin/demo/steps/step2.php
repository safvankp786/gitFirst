<div class="es-step es-step--hidden" id="step2">
    ...
    <div class="es-demo__field-container es-demo__field-container--agent">
        <?php es_settings_field_render( 'google_api_key', array(
            ...
            'type' => 'text',
            'description' => sprintf( __( 'To load Google Maps correctly you shoud enter Google API key. Read more information about %s.', 'es' ), "<a href='https://developers.google.com/maps/documentation/javascript/get-api-key' target='_blank'>" . __( 'getting the key', 'es' ) . "</a>" ),
        ) ); ?>
    </div>
