...
$institution = get_user_meta($uid,'institution',true);
$work_country = get_user_meta($uid,'work_country',true);
$speciality = get_user_meta($uid,'speciality',true);
$interests = get_user_meta($uid,'interests',true);
$newsletter = get_user_meta($uid,'newsletter',true);
...
$profile_data = array(
	...
	array( __( 'Institution/Place of Work', 'tutor' ), $institution ? $institution : '-' ),
	array( __( 'Country of Work', 'tutor' ), $work_country ? $work_country : '-' ),
	array( __( 'User Speciality', 'tutor' ), $speciality ? $speciality : '-' ),
	array( __( 'Interests', 'tutor' ), ( is_array($interests) ? implode(', ', $interests) : '-' ) ),
	array( __( 'Newsletter Subscription', 'tutor' ), $newsletter ? $newsletter : '-' ),
